...
#print(soup.prettify())
name_box = soup.find('section', attrs={'class':'profile-overview block-loosest'}).find('div', attrs={'class':'block-normal clearfix'})#.find('div',attrs={'class':'padding-top-normal'})
#name_box = soup.find('')
name = name_box.text
print(name)
